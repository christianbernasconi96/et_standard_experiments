...
--trainer.callbacks.filename=kenn_horizontal_pairs_L0_adapter_bert \
...
--model configs/et_standard/model/kenn_horizontal_pairs_L0_bert_figer.yaml \
--logger configs/logger.yaml \
--logger.project=figer_et_standard_elmo \
--logger.name=kenn_horizontal_pairs_L0_adapter_bert