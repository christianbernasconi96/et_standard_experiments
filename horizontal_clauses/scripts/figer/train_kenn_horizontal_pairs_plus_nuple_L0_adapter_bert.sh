...
--data configs/et_standard/data/figer_bert.yaml \
...
--trainer.callbacks.filename=kenn_horizontal_pairs_plus_nuple_L0_adapter_bert \
...
--model configs/et_standard/model/kenn_horizontal_pairs_plus_nuple_L0_bert_figer.yaml \
--logger configs/logger.yaml \
--logger.project=figer_et_standard_elmo \
--logger.name=kenn_horizontal_pairs_plus_nuple_L0_adapter_bert