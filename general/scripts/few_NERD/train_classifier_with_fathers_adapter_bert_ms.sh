...
--data configs/et_standard/data/few_NERD_with_fathers_bert_ms.yaml \
...
--trainer.callbacks.filename=classifier_with_fathers_adapter_bert_ms \
...
--logger.name=classifier_with_fathers_adapter_bert_ms