...
$CMD trainers/trainer_kenn_elmo_large.py fit \
--seed_everything=$SEED \
--data configs/et_standard/data/common_elmo.yaml \
--data configs/et_standard/data/ontonotes_augmented_elmo.yaml \
...
--trainer.callbacks.filename=kenn_bottom_up_elmo_mmc \
...
--model configs/et_standard/model/kenn_bottom_up_elmo_mmc.yaml \
--logger configs/logger.yaml \
--logger.project=ontonotes_augmented_et_standard_elmo \
--logger.name=kenn_bottom_up_elmo_mmc