...
--data configs/et_standard/data/ontonotes_denoising_onoe_bert.yaml \
...
--trainer.callbacks.filename=kenn_top_down_adapter_bert \
...
--model configs/et_standard/model/kenn_top_down_bert.yaml \
--logger configs/logger.yaml \
--logger.project=ontonotes_denoising_onoe_et_standard_elmo \
--logger.name=kenn_top_down_adapter_bert